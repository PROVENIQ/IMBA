...
export const imbaRoleProfiles: Record<ImbaRoleKey, ImbaRoleProfile> = {
  ...
  finance: {
    ...
    sectionViews: {
      "Trail Solutions": ["trail-solutions", "trail-solutions-import", "project-command", "project-board"],
      Mission: ["operations"],
  ...
  hr: {
    ...
    sectionViews: {
      ...
      Collaboration: ["collaboration", "collaboration-inbox", "collaboration-connectors", "communications-templates"],
      Management: ["brief", "roadmap"],
    },
  },
  "trail-solutions": {
    ...
    sectionViews: {
      "Trail Solutions": ["trail-solutions", "project-command", "project-board", "construction-reports"],
      Mission: [
        "operations",
        "chapter-network",
        "chapter-standards",
      ...
      Platform: ["platform"],
      Collaboration: ["collaboration", "collaboration-inbox", "collaboration-workspaces", "collaboration-connectors"],
    },
  },
  "planning-design": {
    ...
    home: "trail-solutions",
    sections: ["Trail Solutions", "Mission", "People", "Platform"],
    sectionViews: {
      "Trail Solutions": ["trail-solutions", "project-command", "project-board"],
      Mission: ["operations", "mission-reports", "trail-assets"],
      People: ["people", "capacity", "people-directory", "people-volunteers", "people-training"],
      Platform: ["platform"],
    },
  },
  ...
  communications: {
    ...
    sections: ["Development", "Mission", "Collaboration"],
    sectionViews: {
      Development: ["development-reports", "development-campaigns", "development-marketing", "development-press", "development-partnerships"],
      Mission: ["operations", "impact-research"],
      Collaboration: ["collaboration", "collaboration-connectors", "communications-inbox", "communications-templates"],
    },
  },
  "government-affairs": {
