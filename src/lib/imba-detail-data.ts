...
export const imbaReports = [
  ...
  { name: 'Functional Expense Report', category: 'Compliance', cadence: 'Quarterly', audience: 'Finance + auditors', status: 'Designed', description: 'Program, management/general, and fundraising allocation (2024: 83.3% / 10.2% / 6.6%).' },
